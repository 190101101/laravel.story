<ul class="nav">
        ...
        <div class="profile-desc">
            <div class="profile-pic">
                <div class="count-indicator">
                    <img class="img-xs rounded-circle " src="{{asset('admin')}}/assets/images/logo.svg">
    ...
    <li class="nav-item menu-items">
        <a class="nav-link" data-toggle="collapse" href="#ui-component" aria-expanded="false" aria-controls="ui-component">
        <span class="menu-icon">
